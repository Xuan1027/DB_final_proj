...
class SalaryAdmin(admin.ModelAdmin):
    ...
    list_display = []
    list_display.append("employee_ID")
    ...
    for field in Salary._meta.get_fields():
        if field.name.lower() in Legal_fields:
            list_display.append(field.name)
    list_display.remove("ID")
    list_display[0], list_display[1] = list_display[1], list_display[0]
    search_fields = ("ID_id",)
    # print(list_display, type(list_display))
...
class ProjectAdmin(admin.ModelAdmin):
    ...
    employee_ID.short_description = "principal"
    list_display[1], list_display[3] = list_display[3], list_display[1]
    list_display.remove("principal")
